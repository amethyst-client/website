        ...
        <section ref={sectionRef} className="relative z-30 pb-40 overflow-hidden">
            ...
            <div className="relative mx-auto max-w-5xl px-6 text-center" data-reveal>
                <div className="brutal-chip inline-flex items-center gap-3 px-5 py-2 text-[10px] uppercase tracking-[0.2em] font-medium text-[#c4b5fd] mb-12">
                    <span className="h-1.5 w-1.5 bg-[#8b5cf6] animate-pulse" />
                    Currently in Dev
                </div>
                ...
                <div className="inline-block px-6 py-6 sm:px-10 sm:py-8 text-center">
                    <h2 className="font-heading uppercase leading-[0.9] tracking-tight text-[#e9e7ff] text-[clamp(2.5rem,8vw,4rem)]">
                        Start playing<br /><span className="text-[#c4b5fd] border-b border-[#8b5cf6]/60">with Amethyst.</span>
                    </h2>
                </div>

                <p className="mt-10 mx-auto max-w-xl text-sm sm:text-base text-[#a78bfa]/80 leading-relaxed font-light uppercase">
                    The client is ready for you to try. Get the fastest Minecraft experience and join our community.
                </p>

                <div className="mt-14 flex flex-wrap items-center justify-center gap-6">
                    <ShimmerButton href="/download" className="shimmer-btn brutal-shadow-hover bg-[#6d28d9] text-white px-12 py-4 text-sm font-bold tracking-widest uppercase">
                        Download
                    </ShimmerButton>
